Pod::Spec.new do |s|
  ...
  s.license      = 'BSD'
  s.author       = { "David Beck" => "code@thinkultimate.com", "Eddie Li" => "eli@sandsmedia.com" }
  s.platform     = :ios, '6.0'
  s.source       = { :git => "https://github.com/sandsmedia/TUSafariActivity.git", :tag => s.version.to_s }
  s.requires_arc = true
